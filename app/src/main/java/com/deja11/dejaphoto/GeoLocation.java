...
public class GeoLocation {
    ...
    private boolean isCustomLocationName; // indicates if the location name is a custom user-given name
    ...
    /**
     * Allows a user to give a custom name to the location other than the one generated by buildLocationName().
     * @param customLocationName The new name to associate with the location
     */
    ...
    /**
     * Clears a user-set custom name and sets the name back to the empty string (calling getLocationName() after
     * clearCustomLocationName() will assign and return the normally-generated name again). Does nothing if the
     * location name is not a custom name (since that would be redundant with how getLocationName() works).
     */
